//Original source code by Penpim and Leila
#include <M5Stack.h>
...
void gameover() {
  ...
  {
    int winner = 1;
    if (score < score2) winner = 2;
    M5.Lcd.setCursor(100, 120);
    M5.Lcd.setTextColor(0xffff);
    M5.Lcd.print("WINNER: P");
    M5.Lcd.print(winner);
    ...
    //ledBar(random(0, 256), random(0, 256), random(0, 256), 12);
    M5.Speaker.tone(1200);
    delay(100);
    M5.Speaker.mute();
  }
