...
const char* resource = "https://maker.ifttt.com/trigger/fahpislab9-3/with/key/b7xzZxqmarSkvab43HORKv";
...
// sleep for 30 minutes = 10 seconds
...
void makeIFTTTRequest() {
  ...
  String jsonObject = String("{\"value1\":\"") + String(Temp) + "\",\"value2\":\"" + String(Humidity)
                      + "\",\"value3\":\"" +  + "\"}";
